...
def main() -> None:
    ...
    widgets = {
        ...
        "min_lbl": w.Label("min_lbl", "Min [V]:", 10, 635, 70, 20),
        "c01Min": w.TextUpdate("c01Min", f"{prefix}c01Min", 90, 635, 100, 20),
        "c02Min": w.TextUpdate("c02Min", f"{prefix}c02Min", 210, 635, 100, 20),
        "c03Min": w.TextUpdate("c03Min", f"{prefix}c03Min", 330, 635, 100, 20),
        "c04Min": w.TextUpdate("c04Min", f"{prefix}c04Min", 450, 635, 100, 20),

        "mean_lbl": w.Label("mean_lbl", "Mean [V]:", 10, 660, 70, 20),
        "c01Mean": w.TextUpdate("c01Mean", f"{prefix}c01Mean", 90, 660, 100, 20),
        "c02Mean": w.TextUpdate("c02Mean", f"{prefix}c02Mean", 210, 660, 100, 20),
        "c03Mean": w.TextUpdate("c03Mean", f"{prefix}c03Mean", 330, 660, 100, 20),
        "c04Mean": w.TextUpdate("c04Mean", f"{prefix}c04Mean", 450, 660, 100, 20),

        "rms_lbl": w.Label("rms_lbl", "RMS [V]:", 10, 685, 70, 20),
        "c01RMS": w.TextUpdate("c01RMS", f"{prefix}c01RMS", 90, 685, 100, 20),
        "c02RMS": w.TextUpdate("c02RMS", f"{prefix}c02RMS", 210, 685, 100, 20),
        "c03RMS": w.TextUpdate("c03RMS", f"{prefix}c03RMS", 330, 685, 100, 20),
        "c04RMS": w.TextUpdate("c04RMS", f"{prefix}c04RMS", 450, 685, 100, 20),

        "p2p_lbl": w.Label("p2p_lbl", "P2P [V]:", 10, 710, 70, 20),
        "c01Peak2Peak": w.TextUpdate("c01Peak2Peak", f"{prefix}c01Peak2Peak", 90, 710, 100, 20),
        "c02Peak2Peak": w.TextUpdate("c02Peak2Peak", f"{prefix}c02Peak2Peak", 210, 710, 100, 20),
        "c03Peak2Peak": w.TextUpdate("c03Peak2Peak", f"{prefix}c03Peak2Peak", 330, 710, 100, 20),
